                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.deposit.manual.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="text-center">@lang('Se le solicita que pague la cantidad final de ') {{ getAmount($data['final_amo']) }} {{ $method->currency }} @lang('including') {{ getAmount($data['charge']*$data['rate']) }} {{ $method->currency }} @lang('for charge.')</h4>
                                    <hr>
