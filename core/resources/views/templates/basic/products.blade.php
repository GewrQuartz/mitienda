...
<div class="elfsight-app-2c55f632-cf2e-4e23-ac68-7153db444e13"></div>
<!-- /tochat.be widget -->
                    ...
                    <div class="fileter-select-item">
                        ...
                        <div class="select-item product-page-per-view">
                            <select class="select-bar bg-3">
                                ...
                                <option value="5" {{@$perpage == 5?'selected':''}}>@lang('5 Elementos por página') </option>
                                <option value="15" {{@$perpage == 15?'selected':''}}>@lang('Elementos por página') </option>
                                <option value="30" {{@$perpage == 30?'selected':''}}>@lang('30 Elementos por página') </option>
                                <option value="50" {{@$perpage == 50?'selected':''}}>@lang('50 Elementos por página') </option>
                                <option value="100" {{@$perpage == 100?'selected':''}}>@lang('100 Elementos por página') </option>
                                <option value="200" {{@$perpage == 200?'selected':''}}>@lang('200 Elementos por página') </option>
                            </select>
                        </div>
                    </div>
